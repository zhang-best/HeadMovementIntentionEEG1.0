%准确率77.6596%
tic
load ('C:\Users\user\Desktop\science research\转动意图识别\数据集\FREEFORMSubjectC1512082StLRHand.mat');
t=1;
m=0;
for i = 1:391800
    if(o.marker(i,1)==1)
        m = m+1;
        EEGSignals(m,:,t) = o.data(i,:);
        if(o.marker(i+1,1)==0)
            EEGSignalslabel(t,1) = 1;
            t = t+1;
            m = 0;
        end
    end
...
for i = 1:500
    x_train(:,:,i)=EEGSignals(:,:,i);
    y_train(i,1) = EEGSignalslabel(i,1);
end
for i = 1:188
    x_test(:,:,i)=EEGSignals(:,:,i+500);
    y_test(i,1) = EEGSignalslabel(i+500,1);
end
