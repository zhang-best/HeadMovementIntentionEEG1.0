...
for namei in name:
    for seedi in range(1, 2):
        ...
        import gc
        path = r'E:/science research/2-转动意图识别/laboratory_data&result/data/转头21_mat/'+namei+'/'+namei+'wave300_50s.mat'
        data = h5py.File(path)
        # 读取mat文件
        ...
        for train, val in kfold.split(B, A):
            ...
            if (accuracy_now < accuracy):
                ...
                model.save('E:/pycharm projects/zhuantou3-3class/model/lrmodel' + namei + '.h5')
